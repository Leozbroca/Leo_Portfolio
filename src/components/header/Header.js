...
const Header = () => {
  ...
  return (
    <MainHeader>
      ...
      <HeadMenu>
        <MenuItem color={color1} onClick={mudarPagAbout}>
          About
        </MenuItem>
        <MenuItem color={color2} onClick={mudarPagSkill}>
          My Skills
        </MenuItem>
        <MenuItem color={color3} onClick={mudarPagProject}>
          Projects
        </MenuItem>
        <MenuItem color={color4} onClick={mudarPagContact}>
          Contact
        </MenuItem>
      </HeadMenu>
      <HeadBottom>
